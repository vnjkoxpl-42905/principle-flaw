...
function ElegantShape({
    ...
    const translateX = useTransform(mousePosition?.x || useMotionValue(0), [0, 1200], [15, -15]);
    const translateY = useTransform(mousePosition?.y || useMotionValue(0), [0, 800], [15, -15]);
...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-[500px] w-full flex items-center justify-center overflow-hidden bg-[#030303] rounded-3xl mb-12 shadow-2xl">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <motion.div
                        ...
                        animate="visible"
                    >
                        <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold mb-6 md:mb-8 tracking-tight font-serif italic">
                    ...
                    >
                        <p className="text-sm sm:text-base md:text-lg text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                            Elevate your reasoning. Master every logic gap. <br className="hidden md:block" /> Achieve LSAT excellence through structured intent.
                        </p>
                    </motion.div>
                </div>
            </div>
